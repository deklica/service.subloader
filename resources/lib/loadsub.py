...
# Common ***************************************************************************************************************************************************************************************************
		...
		try:
				...
				addon = "service.subloader" #change when everything is connected
...
# Get release type *****************************************************************************************************************************************************************************************
				...
				filelocal = xbmc.getInfoLabel('Player.Filenameandpath') #works locally
				filestr = vidPath.split('/')[-1] #it works in cache torrents
...
# Filter and subtilte set **********************************************************************************************************************************************************************************
				...
				result = [i for i in result if i['SubSumCD'] == '1'] #see the non result here
